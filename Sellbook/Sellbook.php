...
<form  action="./Sellbook.php" method="POST" enctype="multipart/form-data">
	<div class="TextBooks">
    	...
    	<div class="inputRow">
        	...
        	<input class="myInput" type="text" name="title" id="title" placeholder="Title (must be 1-60 characters in length)" title="Title (must be 1-60 characters in length)" pattern="[a-zA-Z]{1,60}" tabindex=5 required/>
    	</div>
    	<div class="inputRow">
        	<label class="myLabel" for="author"> <span class="asterisk">*</span> Author: </label>
        	<input class="myInput" type="text" name="author" id="author" placeholder="First, Last" title="Please enter the first and last name of the author" pattern="[a-zA-Z]{1,60}" tabindex=6 required/>
    	</div>
    	<div class="inputRow">
        	<label class="myLabel" for="publisher"> Publisher: </label>
        	<input class="myInput" type="text" name="publisher" id="publisher" placeholder="Optional (must be less than 60 characters in length)" pattern="[a-zA-Z]{,60}" tabindex=7 />
    	</div>
    	<div class="inputRow">
